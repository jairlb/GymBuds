...
let itemsArray = localStorage.getItem('itemsKacchan') ? JSON.parse(localStorage.getItem('itemsKacchan')) : [];

localStorage.setItem('itemsKacchan', JSON.stringify(itemsArray));
const data = JSON.parse(localStorage.getItem('itemsKacchan'));
