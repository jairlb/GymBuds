...
let itemsArray = localStorage.getItem('itemsDeku') ? JSON.parse(localStorage.getItem('itemsDeku')) : [];

localStorage.setItem('itemsDeku', JSON.stringify(itemsArray));
const data = JSON.parse(localStorage.getItem('itemsDeku'));
